    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white border-r border-gray-200">
        ...
        <nav className="p-4 space-y-2">
          ...
          <Link
            href="/vendedor/nuevo"
            className="flex items-center gap-3 px-4 py-3 rounded-xl bg-primary-500 text-white hover:bg-primary-600 transition-all"
          >
        ...
        <div className="absolute bottom-0 left-0 right-0 w-64 p-4 border-t border-gray-200 bg-white">
          <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-gray-50 mb-2">
            <div className="w-10 h-10 bg-primary-500 rounded-full flex items-center justify-center font-bold text-sm text-white">
